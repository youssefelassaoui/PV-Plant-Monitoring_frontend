...
function UsersManagement() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get("https://www.pythonanywhere.com/api/users/", {
        headers: {
  ...
  const handleSave = async () => {
    ...
    if (isEditing) {
      try {
        await axios.put(
          `https://www.pythonanywhere.com/api/users/${selectedUser.id}/`,
      ...
      try {
        await axios.post("https://www.pythonanywhere.com/api/register-user/", selectedUser, {
          headers: {
            Authorization: `Bearer ${Cookies.get("access")}`,
          },
        });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://www.pythonanywhere.com/api/users/${id}/`, {
        headers: {
          Authorization: `Bearer ${Cookies.get("access")}`,
        },
      });
