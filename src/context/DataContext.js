    ...
    const fetchData = async () => {
      try {
        const responsePvSystems = await axios.get(
          "https://https://brilliant-sfogliatella-655498.netlify.app/api/pvsystems/",
          {
            headers: {
        ...
        const responseTotalPowers = await axios.get(
          "https://https://brilliant-sfogliatella-655498.netlify.app/api/totals-p_dc/",
          {
            headers: {
              Authorization: `Bearer ${Cookies.get("access")}`,
            },
        ...
        const responseSystemTotals = await axios.get(
          "https://https://brilliant-sfogliatella-655498.netlify.app/api/system-totals/",
          {
            headers: {
              Authorization: `Bearer ${Cookies.get("access")}`,
            },
  ...
  const fetchSystemDetails = async (id) => {
    try {
      const response = await axios.get(
        `https://https://brilliant-sfogliatella-655498.netlify.app/api/pvsystems/${id}/calculate/`,
        {
          headers: {
            Authorization: `Bearer ${Cookies.get("access")}`,
          },
